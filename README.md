...
Built **200+ custom nodes** processing billions of mempool events in real-time. Developed **topology reconnaissance** and p2p protocol hacks for transaction sniping, generating **$2M+ MEV** revenue.
